...
</td><td><input name="CN" id="CN" type="text"></td></tr><tr><td><label for="CU">
Your name:</label></td><td><input name="CU" id="CU" type="text"></td></tr><tr>
<td><label for="CB">Alert name:</label></td><td><input name="CB" id="CB" 
type="text" placeholder="i. e. Streamelements"></td></tr><tr><td><label 
...
LEDs per user</label></td><td><input name="NL" id="NL" type="number" value="9" 
size="1"></td></tr><tr><td><label for="NN">Number of users</label></td><td>
<input name="NN" id="NN" type="number" size="1"></td></tr><tr><td><label 
for="NT">Fade time (seconds)</label></td><td><input name="NT" id="NT" 
type="number" size="1"></td></tr><tr><td><label for="NC">Highlight color</label>
</td><td><input name="NC" id="NC" type="color"></td></tr></table><table 
id="Nlist"></table></span><hr><button type="button" onclick="B()">Back</button>
<button type="submit">Save</button></form></body></html>)=====";
