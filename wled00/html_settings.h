...
function GEV(t){d=document;let e='<h3>Events</h3><table><input type="hidden" name="EVN" value="'+t+'" />';for(e+="<tr><th></th><th>Message</th><th>Macro</th><th>any</th><th>bot</th><th>you</th><th>mods</th><th>vips</th><th>subs</th><th>Time</th></tr>",i=0;i<t;i++)e+='<tr><td><input type="checkbox" name="EN'+(i+1)+'" /></td>',e+='<td><input type="text" placeholder="Hello!" size=10 name="MSG'+(i+1)+'"/></td>',e+='<td><input type="text" placeholder="&PL='+(i+1)+'" size=10 name="M'+(i+1)+'"/></td>',e+='<td><input type="checkbox" name="ANY'+(i+1)+'" /></td>',e+='<td><input type="checkbox" name="BOT'+(i+1)+'" /></td>',e+='<td><input type="checkbox" name="USR'+(i+1)+'" /></td>',e+='<td><input type="checkbox" name="MOD'+(i+1)+'" /></td>',e+='<td><input type="checkbox" name="VIP'+(i+1)+'" /></td>',e+='<td><input type="checkbox" name="SUB'+(i+1)+'" /></td>',e+='<td><input style="text-align: center;" type="text" placeholder="10" size=1 name="TM'+(i+1)+'"/> s</td></tr>';e+="</table>",d.getElementById("events").innerHTML=e}function BNList(t){d=document;let e=d.getElementById("NL").value,n="</th><th>#</th><th>Username</th><th>LEDs</th></tr>";for(i=0;i<t;i++)n+="<tr><td>"+(i+1)+"</td>",n+='<td><input type="text" size=25 maxlength=25 name="USR'+(i+1)+'"/></td>',n+="<td>"+(i*e+1)+" - "+(i+1)*e+"</td>",n+="</tr>";d.getElementById("Nlist").innerHTML=n}function S(){GEV(15),BNList(10),GetV()}function H(){window.open("https://github.com/Aircoookie/WLED/wiki/Twitch")}function B(){window.history.back()}function GetV() {var d=document;
...
name="A2FR"></td><td><input type="color" name="A2TO"></td></tr><tr><td>Color 2:
</td><td><input type="color" name="A2FR"></td><td><input type="color" 
name="A2TO"></td></tr><tr><td>Color 3:</td><td><input type="color" name="A3FR">
</td><td><input type="color" name="A3TO"></td></tr><tr><td>Get current:</td><td>
<input type="button" value="GET"></td><td><input type="button" value="GET"></td>
</tr></table></span><br><span id="names" class="segment"><h3>Username segments
</h3>this lets you highlight certain segments of<br>
