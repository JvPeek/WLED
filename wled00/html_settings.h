...
</tr></table></div><br><div id="names" class="segment"><h3>Username segments
...
id="Nlist"></table><hr><button type="button" onclick="B()">Back</button><button 
